...
| **想查** —— 忘了某個寫法 | [`cheatsheets/`](cheatsheets/README.md)：七頁一眼掃完的速查表（GitHub 上直接看）；瀏覽器開 [`html/index.html`](html/index.html)，全部入口都在、可全文搜尋 |
| **撞到怪行為** —— 「這是已知的坑嗎」 | [`cheatsheets/地雷.md`](cheatsheets/地雷.md)：全部實測過的地雷集中一頁，每條標了出處 |
...
| **想練** —— 「我到底懂了沒」 | [`exercises/`](exercises/README.md)：專挑 ⚠ 陷阱的題目，跑起來會告訴你第幾題錯、附解答 |
...
html/                閱讀器：全部 md 的瀏覽器版（index.html 開檔即看，全文搜尋；content.js 由 bin/md-bundle.py 產生）
